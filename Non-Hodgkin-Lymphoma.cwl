...
steps:
  ...
  lymphoma-nonhodgkin---secondary:
    run: lymphoma-nonhodgkin---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  non-hodgkin-lymphoma-nkcell---secondary:
    run: non-hodgkin-lymphoma-nkcell---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: lymphoma-nonhodgkin---secondary/output
  other-non-hodgkin-lymphoma---secondary:
    run: other-non-hodgkin-lymphoma---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: non-hodgkin-lymphoma-nkcell---secondary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: other-non-hodgkin-lymphoma---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
